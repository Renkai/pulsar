...
public class StreamingOffloadIndexTest {
    //TODO add test for multi ledger
    ...
    public void streamingOffloadIndexBlockImplTest() throws Exception {
        ...
        StreamingOffloadIndexBlock indexBlock = blockBuilder.build();
        ...
        out2.mark(0);
        StreamingOffloadIndexBlock indexBlock2 = blockBuilder.fromStream(out2);
        ...
        try (InputStream stream3 = new ByteArrayInputStream(streamContent, 0, streamLength)) {
            StreamingOffloadIndexBlock indexBlock3 = blockBuilder.fromStream(stream3);
        ...
        try (InputStream stream4 =
            ...
            StreamingOffloadIndexBlock indexBlock4 = blockBuilder.fromStream(stream4);
